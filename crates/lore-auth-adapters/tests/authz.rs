...
#[tokio::test]
async fn authorization_allows_group_writer_and_denies_admin_for_rebac() {
...
#[tokio::test]
async fn authorization_ignores_deleted_repositories_for_rebac() {
    let fixture = migrated_store().await;
    let store = &fixture.store;
    let policy = rebac(store);
    let user = store
...
#[tokio::test]
async fn authorization_returns_not_found_for_unknown_repository_for_rebac() {
    let fixture = migrated_store().await;
    let store = &fixture.store;
    let policy = rebac(store);
    let user = store
...
#[tokio::test]
async fn authorization_applies_roles_prefix_filter_and_sorting_for_rebac() {
    let fixture = migrated_store().await;
    let store = &fixture.store;
    let policy = rebac(store);
    let user = store
...
#[tokio::test]
async fn group_and_grant_crud_updates_authorization_for_rebac() {
    let fixture = migrated_store().await;
    let store = &fixture.store;
    let policy = rebac(store);
    let user = store
...
#[tokio::test]
async fn revoke_is_visible_to_next_check_for_rebac() {
    let fixture = migrated_store().await;
    let store = &fixture.store;
    let policy = rebac(store);
    let user = store
...
#[tokio::test]
async fn unknown_roles_from_raw_sql_fail_closed_for_rebac() {
    let fixture = migrated_store().await;
    let store = &fixture.store;
    let authz = rebac(store);
    let (user_id, resource_id) = user_with_repo(&fixture, "repo-id").await;
...
#[tokio::test]
async fn can_access_role_scan_order_handles_unknown_roles_for_rebac() {
