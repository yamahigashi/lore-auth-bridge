...
上の設定例では `trust.email_binding: verified_email_invitation` を使います。正確な binding と email domain の規則は [Configuration](configuration.ja.md#identity_providers) を参照してください。
